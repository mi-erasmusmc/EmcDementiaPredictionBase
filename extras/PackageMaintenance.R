...
OhdsiRTools::checkUsagePackage("EmcDementiaPredictionBase")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcDementiaPredictionBase.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcDementiaPredictionBase.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcDementiaPredictionBase")
