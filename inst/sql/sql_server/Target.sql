...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (443432,4304008)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (443432,4304008)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (374888,380701,439727,374341,4140090,436092,372241)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (374888,380701,439727,374341,4140090,436092,372241)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21604792)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21604792)
  and c.invalid_reason is null
...
WHERE (C.visit_start_date >= DATEFROMPARTS(2012, 01, 01) and C.visit_start_date <= DATEFROMPARTS(2014, 12, 31))
AND (YEAR(C.visit_start_date) - P.year_of_birth >= 50 and YEAR(C.visit_start_date) - P.year_of_birth <= 79)
